...
class CollectionsPanel(QWidget):
    ...
    def __init__(self) -> None:
        ...
        self.new_collection_button = QPushButton(self.tr("New"))
        self.rename_collection_button = QPushButton(self.tr("Rename"))
        self.delete_collection_button = QPushButton(self.tr("Delete"))
        self.actions_layout.addWidget(self.new_collection_button)
        self.actions_layout.addWidget(self.rename_collection_button)
        self.actions_layout.addWidget(self.delete_collection_button)
        self.panel.addLayout(self.actions_layout)
        ...
        self.detail_toolbar_layout = QHBoxLayout()
        ...
        self.detail_toolbar_layout.addWidget(self.back_button)
        self.detail_toolbar_layout.addWidget(self.detail_title_label)
        self.detail_toolbar_layout.addStretch()
        self.detail_toolbar_layout.addWidget(self.export_button)
    ...
    def _connect_signals(self) -> None:
        self.new_collection_button.clicked.connect(
            self.create_collection_requested_signal.emit
        )
        self.rename_collection_button.clicked.connect(self._emit_rename_requested)
        self.delete_collection_button.clicked.connect(self._emit_delete_requested)
